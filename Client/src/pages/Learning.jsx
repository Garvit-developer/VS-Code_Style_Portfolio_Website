                ...
                <div className="w-full mt-3 mb-5 pb-20 grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-6 px-5">
                    {learningData.map((item) => (
                        <div key={item.id} className="relative group">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl opacity-20 group-hover:opacity-60 transition duration-500 blur-sm"></div>
