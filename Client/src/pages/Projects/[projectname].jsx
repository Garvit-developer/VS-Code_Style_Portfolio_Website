...
const Projectdetails = (props) => {
    ...
    const projectIndex = router.query.projectname
        ? parseInt(router.query.projectname) - 1
        : -1;

    const projectDetails = props.projects && projectIndex >= 0 && projectIndex < props.projects.length
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={`Details of Projects developed.`} />
                <link rel="canonical" href={"https://garvitdani-portfolio.vercel.app"} />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="website" />
                <meta property="og:url" content={"https://garvitdani-portfolio.vercel.app"} />
                <meta property="og:site_name" content="Garvit Dani" />
